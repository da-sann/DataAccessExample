...
{
    public abstract class UnitOfWorkBase<TEntity, TKey> : IUnitOfWork<TEntity, TKey> where TEntity : class, IEntity<TKey>
    {
        ...
        /// <summary>
        /// Method is used for Projections
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual IQueryable<TEntity> GetQueryById(TKey id)
        {
